...
class AlphaBetaTest(unittest.TestCase):
    ...
    def test_cur_branch(self):
        ...
        #board.add_chessman(1, 3, ChessMan(color2))
        #board.add_chessman(2, 1, ChessMan(color1))
        board.add_chessman(2, 2, ChessMan(color2))
        #board.add_chessman(2, 3, ChessMan(color2))
        #board.add_chessman(3, 1, ChessMan(color1))
        #board.add_chessman(3, 2, ChessMan(color1))
        board.add_chessman(3, 3, ChessMan(color2))
        print(AlphaBeta(board, num).get_best_pos(True, color2, color1, 0))
